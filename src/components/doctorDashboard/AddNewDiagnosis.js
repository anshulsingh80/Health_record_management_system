...
const AddNewDiagnosis = (props) => {
  ...
  useEffect(() => {
    async function getDoctor() {
      ...
      tempprescription.hospital.address = `${doctor.orgAddress.building}, ${doctor.orgAddress.city}, ${doctor.orgAddress.street}, ${doctor.orgAddress.district}, ${doctor.orgAddress.state}- ${doctor.orgAddress.pincode}`;
